...
function SaveTORAndVPNConfig(){
  ...
  echo 'sudo /home/pi/loki-network/./lokilaunch.sh bootstrap '.$bootstrap.'', $return;
  $output = shell_exec('sudo /home/pi/./loki-network/lokilaunch.sh bootstrap '.$bootstrap.'',$return);
  echo "<pre>$output</pre>";
